...
MOIS.append(("Janvier", {
 ...
 "depenses": [
    ...
    ("Electrabel",                                        256.99, "Facture 468/9192/57548"),
...
MOIS.append(("Février", {
 ...
 "depenses": [
    ("Achat vêtements sport - Tommy Hilfiger Maasmechelen", 210.49, "Outlet Maasmechelen — « PVH » sur l'extrait"),
    ...
    ("Telenet",                                           149.10, "Facture 309/1274/44771"),
    ...
    ("Parking",                                           1.80, "Commune Saint-Josse"),
    ("Partena",                                           1441.87, "Cotisation trimestrielle — facture 425/0507/35746"),
    ("Farys (eau)",                                       290.00, ""),
    ("Parking",                                           6.50, "Parking Ixelles - Gand"),
    ("Carburant",                                         68.61, "Q8 Easy Zaventem"),
    ("Repas Lunch Garden",                                39.47, "Lunch Garden Kraainem"),
    ("Achat vêtement sport - DECATHLON",                  140.00, "Decathlon Evere — veste JKT MAN 900"),
    ("Précompte salarial février 2025 Thibault Duchène",  2250.00, ""),
    ("SD Worx",                                           331.52, ""),
    ("Carburant",                                         66.07, "Q8 Easy Zaventem"),
    ("Proximus",                                          49.98, "Facture 750/1903/98331"),
 ],
}))
...
MOIS.append(("Mars", {
 ...
 "depenses": [
    ("Achat vêtements de tennis - Bellissimo Sport",      290.50, "New Bs SRL, Bruxelles"),
    ("Crédit voiture",                                    724.12, ""),
    ("Repas Topogigio",                                   75.50, "Ticket pro forma de 79,50 corrigé à la main à 75,50"),
    ...
    ("Telenet",                                           149.40, "Facture 309/3944/58489"),
    ...
    ("Partena",                                           3014.00, "Régularisation — facture 425/0248/37251"),
    ("Entretien voiture - Monsieur Pneus",                919.17, "4 pneus Uniroyal + géométrie, VW Tiguan — facture 22501184"),
...
MOIS.append(("Avril", {
 ...
 "depenses": [
    ...
    ("Achat vêtements - N.Z.A. Utrecht",                  289.97, "3 articles, Utrecht (Pays-Bas)"),
    ("Proximus",                                          141.50, "Facture 750/2441/84528"),
    ("Parking",                                           32.76, "Commune d'Utrecht (Pays-Bas)"),
    ("Telenet",                                           149.10, "Facture 309/6596/00616"),
    ...
    ("Repas Topogigio",                                   26.00, "Bar du RTCL Lambermont, 23-04 à 16:09 — 12 pièces (sodas et gaufres), ticket de 29,00 pour 26,00 débités"),
...
MOIS.append(("Mai", {
 ...
 "depenses": [
    ...
    ("SD Worx",                                           331.99, ""),
    ("Farys (eau)",                                       290.00, ""),
    ("Proximus",                                          71.54, "Facture 750/2981/21578"),
    ...
    ("Telenet",                                           149.10, "Facture 309/9292/68801"),
...
MOIS.append(("Juin", {
 ...
 "depenses": [
    ...
    ("Partena",                                           1441.87, "Cotisation trimestrielle — facture 425/0719/16405"),
    ("SD Worx",                                           331.99, ""),
    ...
    ("Telenet",                                           155.52, "Facture 310/1956/94152"),
    ("Proximus",                                          64.94, "Facture 750/3518/42505"),
...
MOIS.append(("Juillet", {
 ...
 "depenses": [
    ...
    ("Electrabel",                                        356.79, "Décompte annuel (afrekening) — facture 455/1399/88731 ; l'acompte passe ensuite de 256,99 à 263,44"),
    ("Telenet",                                           153.42, "Facture 310/4609/85819"),
    ("Amende de stationnement - Saint-Josse",             100.00, "Amende — dépense non admise, comm. 500/2300/37391"),
    ("Carburant",                                         60.90, "Maes Schaerbeek"),
    ("Parking",                                           1.60, "Woluwe-Saint-Lambert"),
    ("Repas Topogigio",                                   231.50, "Bar du RTCL Lambermont, 25-07 à 15:05 — 85 pièces pour un groupe (sodas, gaufres, chips, croque-monsieur), ticket de 251,50 pour 231,50 débités via SumUp"),
...
MOIS.append(("Août", {
 ...
 "depenses": [
    ...
    ("Parking",                                           1.60, "Woluwe-Saint-Lambert"),
    ("Achat matériel sportif - DECATHLON",                123.00, "Decathlon Evere — 28 balles de tennis, remboursé par le RTC Lambermont le même jour"),
...
MOIS.append(("Septembre", {
 ...
 "depenses": [
    ...
    ("Farys (eau)",                                       300.00, ""),
    ("Crédit voiture",                                    724.12, ""),
    ("Proximus",                                          70.62, "Facture 750/5179/27218"),
    ...
    ("Parking",                                           1.60, "Woluwe-Saint-Lambert"),
    ("Proximus",                                          161.83, "Facture 750/5709/83285 — 2e facture du mois"),
    ...
    ("Repas - TotalEnergies Nivelles",                    13.65, "Aire d'Orival E19 — restauration, pas du carburant"),
    ("Achat matériel sportif - Bellissimo Sport",         40.00, "Chaussures Babolat Pulsion Kid (enfants, pointure 29)"),
 ],
}))
...
MOIS.append(("Octobre", {
 ...
 "depenses": [
    ...
    ("Proximus",                                          148.72, "Facture 750/6239/84691"),
...
MOIS.append(("Novembre", {
 ...
 "depenses": [
    ...
    ("Parking",                                           1.60, "Woluwe-Saint-Lambert"),
    ("Parking",                                           1.60, "Woluwe-Saint-Lambert"),
    ("Partena",                                           1441.87, "Cotisation trimestrielle — facture 425/1102/67272"),
    ...
    ("Proximus",                                          143.48, "Facture 750/6769/40530"),
    ("Carburant",                                         65.52, "Shell Haine-Saint-Pierre"),
    ("Parking",                                           0.90, "Schaerbeek"),
    ("Parking",                                           2.68, "Louvain"),
    ("Achat matériel sportif - DECATHLON",                118.50, "Decathlon Evere — 10 articles dont masque de ski, luge et vêtements enfant : usage professionnel à confirmer"),
    ("Parking",                                           12.60, "Parking Rogier"),
    ("Parking",                                           1.60, "Woluwe-Saint-Lambert"),
    ("Carburant",                                         69.11, "Q8 Easy Zaventem"),
    ("Parking",                                           1.85, "Q-Park Woluwe Esplanade"),
    ("Semelles orthopédiques de travail - Podomed",       65.00, "Bilan et prise de mesures du 27-11 — facture Podomed 2025-30, équipement de travail : Thibault Duchène est entraîneur de tennis, debout et en déplacement toute la journée"),
    ("Parking",                                           5.55, "Q-Park Woluwe Esplanade"),
    ("Parking",                                           1.60, "Woluwe-Saint-Lambert"),
 ],
}))
...
MOIS.append(("Décembre", {
 ...
 "depenses": [
    ...
    ("Semelles orthopédiques de travail - Podomed",       210.00, "Semelles de travail sur mesure — même facture Podomed 2025-30, liées à l'exercice du métier d'entraîneur de tennis"),
