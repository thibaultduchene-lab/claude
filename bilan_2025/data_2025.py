...
MOIS.append(("Novembre", {
 ...
 "depenses": [
    ...
    ("Parking",                                           1.85, "Q-Park Woluwe Esplanade"),
    ("Semelles orthopédiques de travail - Podomed",       65.00, "Bilan et prise de mesures du 27-11 — soin paramédical facturé à la société : déductibilité à trancher"),
    ("Parking",                                           5.55, "Q-Park Woluwe Esplanade"),
    ("Parking",                                           1.60, "Woluwe-Saint-Lambert"),
 ],
}))
...
MOIS.append(("Décembre", {
 ...
 "depenses": [
    ...
    ("Semelles orthopédiques de travail - Podomed",       210.00, "Semelles de travail sur mesure — soin paramédical facturé à la société : déductibilité à trancher"),
