...
MOIS.append(("Octobre", {
 ...
 "entrees": [
    ("LAM2511", 3858.09, ""),
    ("LAM2512", 13994.00, "Montant inhabituel — facture assujettie à la TVA comme LAM2412 en 2024 ?"),
    ("Prestations octobre 2025 - RTC Lambermont", 4525.72, "Communication sans numéro de facture LAM"),
 ],
 "depenses": [
    ("Crédit voiture",                                    724.12, ""),
